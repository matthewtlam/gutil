...
#ifndef PINS_INFRA_LIB_VALIDATOR_VALIDATOR_BACKEND_H_
#define PINS_INFRA_LIB_VALIDATOR_VALIDATOR_BACKEND_H_
...
#endif  // PINS_INFRA_LIB_VALIDATOR_VALIDATOR_BACKEND_H_

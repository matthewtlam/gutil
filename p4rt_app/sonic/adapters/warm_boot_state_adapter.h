...
#ifndef PINS_INFRA_P4RT_APP_SONIC_ADAPTERS_WARM_BOOT_STATE_ADAPTER_H_
#define PINS_INFRA_P4RT_APP_SONIC_ADAPTERS_WARM_BOOT_STATE_ADAPTER_H_
...
class WarmBootStateAdapter {
 public:
  ...
  // If StateVerification for WarmBoot boot up is disabled and OrchAgent is
  // reconciled, return false - P4RT will not wait for unfreeze. Otherwise,
  // return true.
...
#endif  // PINS_INFRA_P4RT_APP_SONIC_ADAPTERS_WARM_BOOT_STATE_ADAPTER_H_

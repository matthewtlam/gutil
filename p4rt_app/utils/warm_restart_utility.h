...
#ifndef PINS_INFRA_P4RT_APP_UTILS_WARM_RESTART_UTILITY_H_
#define PINS_INFRA_P4RT_APP_UTILS_WARM_RESTART_UTILITY_H_
...
class WarmRestartUtil {
 ...
 private:
  ...
  // CONFIG DB table to query CPU and FRONT_PANEL queues.
...
#endif  // PINS_INFRA_P4RT_APP_UTILS_WARM_RESTART_UTILITY_H_

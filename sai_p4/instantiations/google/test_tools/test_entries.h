...
#ifndef PINS_INFRA_SAI_P4_INSTANTIATIONS_GOOGLE_TEST_TOOLS_TEST_ENTRIES_H_
#define PINS_INFRA_SAI_P4_INSTANTIATIONS_GOOGLE_TEST_TOOLS_TEST_ENTRIES_H_
...
class EntryBuilder {
 public:
  ...
  EntryBuilder& AddEntryPuntingPacketsWithDstMac(absl::string_view dst_mac);
...
#endif  // PINS_INFRA_SAI_P4_INSTANTIATIONS_GOOGLE_TEST_TOOLS_TEST_ENTRIES_H_

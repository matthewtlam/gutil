...
#define SAI_INSTANTIATION_EXPERIMENTAL_TOR
...
control egress(inout headers_t headers,
  ...
  apply {
    ...
    if (!IS_PACKET_IN_COPY(standard_metadata)) {
      ...
      egress_port_loopback.apply(headers, local_metadata, standard_metadata);
    }
  }
}  // control egress

#ifndef PKG_INFO_NAME
#define PKG_INFO_NAME "experimental_tor.p4"
#endif
@pkginfo(
  name = PKG_INFO_NAME,
  organization = "Google",

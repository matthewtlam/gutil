...
const P4Info& GetP4Info(Instantiation instantiation) {
  ...
  static const P4Info* const kExperimentalTopOfRackP4Info =
      new P4Info(FetchP4Info(Instantiation::kExperimentalTor));
  ...
  switch (instantiation) {
    ...
    case Instantiation::kExperimentalTor:
      return *kExperimentalTopOfRackP4Info;
...
const IrP4Info& GetIrP4Info(Instantiation instantiation) {
  ...
  static const IrP4Info* const kExperimentalTorIrP4Info =
      CreateIrP4Info(GetP4Info(Instantiation::kExperimentalTor));
  ...
  switch (instantiation) {
    ...
    case Instantiation::kTor:
      return *kTorIrP4Info;
    case Instantiation::kExperimentalTor:
      return *kExperimentalTorIrP4Info;
    case Instantiation::kWbb:
      return *kWbbIrP4Info;
  }
  LOG(DFATAL) << "Obtaining P4Info for invalid instantiation: "

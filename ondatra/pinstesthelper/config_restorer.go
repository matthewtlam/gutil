...
func NewConfigRestorerWithIgnorePaths(t *testing.T, ignorePaths []string) *ConfigRestorer {
	...
	for id, device := range devices {
		...
		// TODO: b/331470903 - Try to cache the config to reduce the fetch requests.
		// But if we want to capture individual config changes, maybe caching would not be
		// helpful.
...
// TODO: b/335325217 - Remove certain paths that are inconsistent when comparing.

...
#include "ondatra/thinkit/ondatra_generic_testbed_fixture.h"
...
#include "ondatra/thinkit/ondatra_generic_testbed.h"
    ...
    switch (requirement.interface_mode()) {
      case thinkit::CONTROL_INTERFACE: {
        ...
        for (int control_device_interface_index = 0;
          ...
          // Currently, the GPINs bind has ports named as portN, where N is
          // 1-indexed.
...
GetSutInterfaceInfoFromReservation(
  ...
  // because GPINs bind does not properly support those.

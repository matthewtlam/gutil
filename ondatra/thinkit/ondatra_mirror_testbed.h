...
#ifndef PINS_INFRA_ONDATRA_THINKIT_ONDATRA_MIRROR_TESTBED_H_
#define PINS_INFRA_ONDATRA_THINKIT_ONDATRA_MIRROR_TESTBED_H_
...
#endif  // PINS_INFRA_ONDATRA_THINKIT_ONDATRA_MIRROR_TESTBED_H_

...
import (
	...
	"github.com/pins/pins-infra/ondatra/binding/gpinsbind"
...
//export platforms_networking_gpins_ondatra_thinkit_Init
func platforms_networking_gpins_ondatra_thinkit_Init(testbedIn C.struct_ProtoIn, waitTime, runTime C.long, errMsg C.struct_StringOut) {
	tb := &opb.Testbed{}
...
//export platforms_networking_gpins_ondatra_thinkit_Testbed
func platforms_networking_gpins_ondatra_thinkit_Testbed(resvOut C.struct_ProtoOut, errMsg C.struct_StringOut) {
	resv, err := Testbed()
	writeProto(resv, resvOut)
	writeErrorString(err, errMsg)
}

//export platforms_networking_gpins_ondatra_thinkit_Release
func platforms_networking_gpins_ondatra_thinkit_Release(errMsg C.struct_StringOut) {

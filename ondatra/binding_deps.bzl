...
def binding_deps():
    ...
    go_repository(
        ...
        version = "v1.0.0",
        patches = ["@com_github_google_pins_infra//:bazel/patches/ondatra/ghodss_yaml.patch"],
        patch_args = ["-p1"],
    )
    ...
    go_repository(
        ...
        patches = ["@com_github_google_pins_infra//:bazel/patches/ondatra/ondatra.patch"],
        patch_args = ["-p1"],
    ...
    go_repository(
        ...
        patches = ["@com_github_google_pins_infra//:bazel/patches/ondatra/snappi.patch"],
        patch_args = ["-p1"],
    )
    ...
    go_repository(
        ...
        patches = ["@com_github_google_pins_infra//:bazel/patches/ondatra/gnmi.patch"],
        patch_args = ["-p1"],
    )
    ...
    go_repository(
        ...
        patches = ["@com_github_google_pins_infra//:bazel/patches/ondatra/ygnmi.patch"],
        patch_args = ["-p1"],
    )
    ...
    go_repository(
        ...
        patches = ["@com_github_google_pins_infra//:bazel/patches/ondatra/gnoi.patch"],
        patch_args = ["-p1"],
    )
    ...
    go_repository(
        ...
        patches = ["@com_github_google_pins_infra//:bazel/patches/ondatra/gnsi.patch"],
        patch_args = ["-p1"],
    )
    ...
    go_repository(
        ...
        patches = ["@com_github_google_pins_infra//:bazel/patches/ondatra/gribi.patch"],
        patch_args = ["-p1"],
    )
    ...
    go_repository(
        ...
        patches = ["@com_github_google_pins_infra//:bazel/patches/ondatra/ygot.patch"],
        patch_args = ["-p1"],
    )
    ...
    go_repository(
        ...
        patches = ["@com_github_google_pins_infra//:bazel/patches/ondatra/p4lang.patch"],
        patch_args = ["-p1"],
    )

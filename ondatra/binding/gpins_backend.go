// Package gpinsbackend can reserve Ondatra DUTs and provide clients to interact with the DUTs.
package gpinsbackend
...
func (b *Backend) GNMIClient(ctx context.Context, dut *binding.AbstractDUT, conn *grpc.ClientConn) (gpb.GNMIClient, error) {
	...
	// TODO: b/311281971 - Cache GNMIClient if possible.
	if dut == nil {

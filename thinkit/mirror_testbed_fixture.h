...
#ifndef PINS_INFRA_THINKIT_MIRROR_TESTBED_TEST_FIXTURE_H_
#define PINS_INFRA_THINKIT_MIRROR_TESTBED_TEST_FIXTURE_H_
...
#endif  // PINS_INFRA_THINKIT_MIRROR_TESTBED_TEST_FIXTURE_H_

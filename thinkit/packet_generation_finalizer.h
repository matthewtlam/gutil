...
#ifndef PINS_INFRA_THINKIT_PACKET_GENERATION_FINALIZER_H_
#define PINS_INFRA_THINKIT_PACKET_GENERATION_FINALIZER_H_
...
#endif  // PINS_INFRA_THINKIT_PACKET_GENERATION_FINALIZER_H_

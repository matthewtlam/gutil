...
#ifndef PINS_INFRA_TESTS_LIB_COMMON_IR_TABLE_ENTRIES_H_
#define PINS_INFRA_TESTS_LIB_COMMON_IR_TABLE_ENTRIES_H_
...
#endif  // PINS_INFRA_TESTS_LIB_COMMON_IR_TABLE_ENTRIES_H_

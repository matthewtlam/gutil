#ifndef PINS_INFRA_TESTS_LIB_SWITCH_TEST_SETUP_HELPERS_H_
#define PINS_INFRA_TESTS_LIB_SWITCH_TEST_SETUP_HELPERS_H_
...
// A `const&`-like view of a complete or partial GPINS config, meaning the
...
#endif  // PINS_INFRA_TESTS_LIB_SWITCH_TEST_SETUP_HELPERS_H_

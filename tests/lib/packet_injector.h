...
#ifndef PINS_INFRA_TESTS_LIB_PACKET_INJECTOR_H_
#define PINS_INFRA_TESTS_LIB_PACKET_INJECTOR_H_

#include <memory>
#include <optional>
#include <string>
#include <thread>  // NOLINT (third-party)
#include <vector>
 ...
 public:
  ...
  static absl::StatusOr<std::unique_ptr<PacketInjector>> Create(
      ...
      absl::AnyInvocable<
          ...
          injector = gpins::InjectEgressPacket);
...
#endif  // PINS_INFRA_TESTS_LIB_PACKET_INJECTOR_H_

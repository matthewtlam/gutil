...
absl::Status CheckControlDeviceInterfaceLinkState(
    thinkit::GenericTestbed& generic_testbed, std::string interface,
    bool is_link_up, int peer_device_index) {
  ASSIGN_OR_RETURN(
      auto up_links,
...
absl::Status FlapLink(gnmi::gNMI::StubInterface& gnmi_stub,
  ...
  // TODO: b/327583250 - Remove this check once the support is available for

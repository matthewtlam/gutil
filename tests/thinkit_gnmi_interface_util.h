...
#ifndef PINS_INFRA_TESTS_THINKIT_GNMI_INTERFACE_UTIL_H_
#define PINS_INFRA_TESTS_THINKIT_GNMI_INTERFACE_UTIL_H_
...
#endif  // PINS_INFRA_TESTS_THINKIT_GNMI_INTERFACE_UTIL_H_

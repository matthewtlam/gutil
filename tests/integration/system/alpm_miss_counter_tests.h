...
#ifndef PINS_INFRA_TESTS_INTEGRATION_SYSTEM_ALPM_MISS_COUNTER_TESTS_H_
#define PINS_INFRA_TESTS_INTEGRATION_SYSTEM_ALPM_MISS_COUNTER_TESTS_H_
...
#endif  // PINS_INFRA_TESTS_INTEGRATION_SYSTEM_ALPM_MISS_COUNTER_TESTS_H_

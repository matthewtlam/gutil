#ifndef PINS_INFRA_TESTS_INTEGRATION_SYSTEM_NSF_INTERFACES_TESTBED_H_
#define PINS_INFRA_TESTS_INTEGRATION_SYSTEM_NSF_INTERFACES_TESTBED_H_
...
inline absl::StatusOr<thinkit::GenericTestbed*> GetGenericTestbed(
...
inline absl::StatusOr<thinkit::MirrorTestbed*> GetMirrorTestbed(
    const Testbed& testbed) {
...
#endif  // PINS_INFRA_TESTS_INTEGRATION_SYSTEM_NSF_INTERFACES_TESTBED_H_

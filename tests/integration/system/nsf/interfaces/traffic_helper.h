...
#ifndef PINS_INFRA_TESTS_INTEGRATION_SYSTEM_NSF_INTERFACES_TRAFFIC_HELPER_H_
#define PINS_INFRA_TESTS_INTEGRATION_SYSTEM_NSF_INTERFACES_TRAFFIC_HELPER_H_
...
class TrafficHelper {
 public:
  ...
  virtual absl::Status ValidateTraffic(
      const Testbed& testbed, absl::Duration max_acceptable_outage) = 0;
...
#endif  // PINS_INFRA_TESTS_INTEGRATION_SYSTEM_NSF_INTERFACES_TRAFFIC_HELPER_H_

...
#ifndef PINS_INFRA_TESTS_INTEGRATION_SYSTEM_NSF_UPGRADE_TEST_H_
#define PINS_INFRA_TESTS_INTEGRATION_SYSTEM_NSF_UPGRADE_TEST_H_
...
#endif  // PINS_INFRA_TESTS_INTEGRATION_SYSTEM_NSF_UPGRADE_TEST_H_

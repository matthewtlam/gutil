...
#include <memory>
#include <string>
#include <thread>  // NOLINT: Need to add thread for parallel link flap.
#include <utility>
#include <vector>
...
TEST_P(NsfLinkFlapTestFixture, NsfLinkFlapTest) {
  ...
  generic_testbed->Environment().SetTestCaseID(
      "1b1302bb-530c-4d54-8ad4-2d3960dad4eb");
  LOG(INFO) << "Get interface info of all interfaces in SUT.";
  // TODO: b/327304747 - Replace below code with GetAllControlLinks once the
  ...
  // TODO: b/324839731 - Directly use GenericTestbed instead of constructing

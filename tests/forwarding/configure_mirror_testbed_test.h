...
#ifndef PINS_INFRA_TESTS_FORWARDING_CONFIGURE_MIRROR_TESTBED_TEST_H_
#define PINS_INFRA_TESTS_FORWARDING_CONFIGURE_MIRROR_TESTBED_TEST_H_
...
#endif  // PINS_INFRA_TESTS_FORWARDING_CONFIGURE_MIRROR_TESTBED_TEST_H_

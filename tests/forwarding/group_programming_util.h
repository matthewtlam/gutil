...
#ifndef PINS_INFRA_TESTS_FORWARDING_GROUP_PROGRAMMING_H_
#define PINS_INFRA_TESTS_FORWARDING_GROUP_PROGRAMMING_H_
...
#endif  // PINS_INFRA_TESTS_FORWARDING_GROUP_PROGRAMMING_H_

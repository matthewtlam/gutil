...
#ifndef PINS_INFRA_TESTS_FORWARDING_PACKET_TEST_UTIL_H_
#define PINS_INFRA_TESTS_FORWARDING_PACKET_TEST_UTIL_H_
...
#endif  // PINS_INFRA_TESTS_FORWARDING_PACKET_UTIL_H_

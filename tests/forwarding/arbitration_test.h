...
#ifndef PINS_INFRA_TESTS_FORWARDING_ARBITRATION_TEST_H_
#define PINS_INFRA_TESTS_FORWARDING_ARBITRATION_TEST_H_
...
#endif  // PINS_INFRA_TESTS_FORWARDING_ARBITRATION_TEST_H_

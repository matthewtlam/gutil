...
absl::StatusOr<std::vector<p4::v1::Entity>> InstallIngressAclRedirectToNexthop(
    pdpi::P4RuntimeSession& switch_session, std::string given_port,
  ...
  switch (GetParam().tunnel_type) {
    case pins_test::TunnelMatchType::kTernaryMatchSrcIp:
      testbed.Environment().SetTestCaseID(
          "d5bb5571-ecc0-4a46-aac4-02a0c7f79df9");
      break;
    case pins_test::TunnelMatchType::kTernaryMatchDstIp:
      testbed.Environment().SetTestCaseID(
          "e986d859-59ec-4a8f-acc0-c586cecf0eb2");
      break;
    case pins_test::TunnelMatchType::kExactMatch:
      testbed.Environment().SetTestCaseID(
          "80ddbc10-4b85-4021-8093-0ac48e72b2de");
      break;
  }
...
TEST_P(TunnelDecapTestFixture, BasicTunnelTermDecapv6Inv6) {
  ...
  switch (GetParam().tunnel_type) {
    case pins_test::TunnelMatchType::kTernaryMatchDstIp:
      testbed.Environment().SetTestCaseID(
          "b7716ba9-4266-48dc-9815-10093603f597");
      break;
    case pins_test::TunnelMatchType::kTernaryMatchSrcIp:
      testbed.Environment().SetTestCaseID(
          "6b0297a7-75cd-412b-be24-61c8fb363399");
      break;
    case pins_test::TunnelMatchType::kExactMatch:
      testbed.Environment().SetTestCaseID(
          "79060cd7-6001-4925-85e5-4bb8b1ec56ae");
      break;
  }
...
TEST_P(TunnelDecapTestFixture, BasicTunnelTermDecapNoAdmit) {
  ...
  // Set testbed environment
  testbed.Environment().SetTestCaseID("9ae3e97d-9e49-45ce-bd32-fd7544fc71dd");
...
TEST_P(TunnelDecapTestFixture, NoAdmitTableAclRedirectTunnelTermNoDecapForV4) {
  ...
  // Set testbed environment
  testbed.Environment().SetTestCaseID("9700e6f9-01b3-40dc-905a-e152f22b5214");
...
TEST_P(TunnelDecapTestFixture, AdmitTableAclRedirectTunnelTermDecapForV4) {
  ...
  // Set testbed environment
  testbed.Environment().SetTestCaseID("5e6afa7b-a5f0-4a33-8d91-dae35eee0845");

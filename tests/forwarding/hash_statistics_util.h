...
#ifndef PINS_INFRA_TESTS_FORWARDING_HASH_STATISTICS_UTIL_H_
#define PINS_INFRA_TESTS_FORWARDING_HASH_STATISTICS_UTIL_H_
...
absl::Status TestDistribution(const std::vector<gpins::GroupMember>& members,
...
inline absl::Status TestDistribution(
    const std::vector<gpins::GroupMember>& members, const Distribution& results,
    double target_confidence, int expected_packets, Statistic statistic) {
...
#endif  // PINS_INFRA_TESTS_FORWARDING_HASH_STATISTICS_UTIL_H_

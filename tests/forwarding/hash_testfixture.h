...
#ifndef PINS_INFRA_TESTS_FORWARDING_HASH_TESTFIXTURE_H_
#define PINS_INFRA_TESTS_FORWARDING_HASH_TESTFIXTURE_H_
...
using TestConfigurationMap =
    absl::btree_map<std::string /*test_name*/, gpins::TestConfiguration>;
using TestPacketMap =
...
class HashTest : public testing::Test {
 public:
  ...
  absl::StatusOr<std::string> GnmiInterfaceName(
...
#endif  // PINS_INFRA_TESTS_FORWARDING_HASH_TESTFIXTURE_H_

...
#ifndef PINS_INFRA_TESTS_PACKET_CAPTURE_PACKET_CAPTURE_TEST_UTIL_H_
#define PINS_INFRA_TESTS_PACKET_CAPTURE_PACKET_CAPTURE_TEST_UTIL_H_
...
// For example, GNMI port name "Ethernet1/1/1" corresponds to Broadcom vendor
// port id "1".
absl::StatusOr<std::string> GetVendorPortId(
    absl::string_view gnmi_port_name, gnmi::gNMI::StubInterface *gnmi_stub);
...
#endif  // PINS_INFRA_TESTS_PACKET_CAPTURE_PACKET_CAPTURE_TEST_UTIL_H_

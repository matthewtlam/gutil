...
std::unique_ptr<google::protobuf::Message> InterceptRequest(
  ...
  auto* write_request =
      google::protobuf::DynamicCastToGenerated<WriteRequest>(&request);
  auto* read_request =
      google::protobuf::DynamicCastToGenerated<ReadRequest>(&request);
  auto* set_config_request = google::protobuf::DynamicCastToGenerated<
      SetForwardingPipelineConfigRequest>(&request);
  auto* get_config_request = google::protobuf::DynamicCastToGenerated<
      GetForwardingPipelineConfigRequest>(&request);
  auto* stream_request =
      google::protobuf::DynamicCastToGenerated<StreamMessageRequest>(&request);
...
void InterceptResponse(google::protobuf::Message& response,
  ...
  auto* write_response =
      google::protobuf::DynamicCastToGenerated<WriteResponse>(&response);
  auto* read_response =
      google::protobuf::DynamicCastToGenerated<ReadResponse>(&response);
  auto* set_config_response = google::protobuf::DynamicCastToGenerated<
      SetForwardingPipelineConfigResponse>(&response);
  auto* get_config_response = google::protobuf::DynamicCastToGenerated<
      GetForwardingPipelineConfigResponse>(&response);
  auto* stream_response =
      google::protobuf::DynamicCastToGenerated<StreamMessageResponse>(
          &response);
